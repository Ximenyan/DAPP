...
$(document).ready(function () {
    ...
    $.get('/api?req_type=query_order_rank&order_type=_SELL___List_Tail_Order___ONG_ONT_', function (data) {
        ...
        console.log(arr);
        for (var i in arr) {
            $("#sell_table").append("<tr><td style='color:#669933'>" + arr[i].Price / 1000000000 + "</td><td style='color:#669933'>" + (arr[i].Price * arr[i].UnAmount) / 1000000000 + "</td><td style='color:#669933'>" + arr[i].UnAmount + "</td></tr>");
        }
    });
    // Create a socket
